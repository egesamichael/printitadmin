...
export default function Home() {
  ...
  return (
    // Parent container with blue background and centered content
    <div className="flex items-center justify-center min-h-screen bg-blue-500">
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus:ring-0 dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
              />
          ...
          {/* Optional: Link to Sign Up or Forgot Password */}
